@props(['href' => null, 'danger' => false, 'secondary' => false, 'outline' => false, 'uppercase' => false, 'icon' => '' ])

@php
    $baseClasses = 'inline-flex items-center px-4 py-3 rounded-md font-medium text-sm tracking-widest focus:outline-none focus:ring-2 focus:ring-offset-2 transition ease-in-out duration-150';
    ...
    $iconHtml = $icon ? "<i class='fa-solid {$icon} mr-1.5'></i>" : '';
@endphp
